 ...
 */
void loop(const char *my_name, struct k_sem *my_sem, struct k_sem *other_sem, struct gpio_dt_spec *led)
{
	const char *tname;
	uint8_t cpu;
...
void threadB(void *dummy1, void *dummy2, void *dummy3)
{
	...
	loop(__func__, &threadB_sem, &threadA_sem, &led1);
}
...
void threadA(void *dummy1, void *dummy2, void *dummy3)
{
	...
	loop(__func__, &threadA_sem, &threadB_sem, &led0);
}
